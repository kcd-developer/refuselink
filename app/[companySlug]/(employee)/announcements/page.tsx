...
export default async function AnnouncementsPage({ params }: { params: { companySlug: string } }) {
  ...
  return <AnnouncementsClient announcements={announcements as any} companySlug={params.companySlug} cities={cities} communities={communities} />
}
